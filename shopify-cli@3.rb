...
class ShopifyCliAT3 < Formula
  ...
  url "https://registry.npmjs.org/@shopify/cli/-/cli-3.11.0.tgz"
  sha256 "366863bddd3d7cda16ceb4fec89367ec9ba49dcc1a139e8a44c234873079e22a"
  license "MIT"
  depends_on "node"
  depends_on "ruby"
  depends_on "git"
  ...
  resource "cli-theme-commands" do
    url "https://registry.npmjs.org/@shopify/theme/-/theme-3.11.0.tgz"
    sha256 "58f3c135b5ac287432dfd7a7c5f420bb84be646dc5bc3636a381a18fb795f60d"
  end
