class OauthTunnelClientM1 < Formula

  desc 'Create a secure local proxy with Shopify GCP services on Apple Silicon'
  ...
  test do
    system "#{bin}/oauth-tunnel-client_darwin_arm64", "version"
  end
end
